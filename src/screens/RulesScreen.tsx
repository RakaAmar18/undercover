        ...
        <ScreenContainer style={styles.container}>
            ...
            <ScrollView style={styles.scroll}>
                <View style={styles.section}>
                    <ComicText variant="h3" color={COLORS.secondary} numberOfLines={1} adjustsFontSizeToFit>1. PERAN</ComicText>
                ...
                <View style={styles.section}>
                    <ComicText variant="h3" color={COLORS.secondary} numberOfLines={1} adjustsFontSizeToFit>2. CEK KARTU</ComicText>
                    <ComicText variant="body">
                ...
                <View style={styles.section}>
                    <ComicText variant="h3" color={COLORS.secondary} numberOfLines={1} adjustsFontSizeToFit>3. DISKUSI</ComicText>
                    <ComicText variant="body">
                ...
                <View style={styles.section}>
                    <ComicText variant="h3" color={COLORS.secondary} numberOfLines={1} adjustsFontSizeToFit>4. ELIMINASI</ComicText>
                    <ComicText variant="body">
                ...
                <View style={styles.section}>
                    <ComicText variant="h3" color={COLORS.secondary} numberOfLines={1} adjustsFontSizeToFit>5. PEMENANG</ComicText>
                    <ComicText variant="body">
